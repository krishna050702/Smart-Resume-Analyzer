...
def run():
    ...
    st.image(img)
    st.sidebar.markdown("# Choose the Following...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="https://github.com/krishna050702/" style="text-decoration: none; color: #D2FFFF;">Krishna Mundada</a></b>' 
    ...
    if choice == 'User':
        ...
        # Upload Resume
        st.markdown('''<h5 style='text-align: left; color: #D2C8FA;'> Upload Your Resume, And Get Smart Recommendations</h5>''',unsafe_allow_html=True)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <ul>
            <li>
            <a href="https://krishna050702.github.io/PortfolioReact/" style="text-decoration: none; color: grey;">Krishna Mundada,</a> Check-out  
            <a href="https://www.linkedin.com/in/krishna-mundada/" style="text-decoration: none; color: grey;"> LinkedIn</a> <br>
            </li>
            <li>
            <a href="https://krishna050702.github.io/PortfolioReact/" style="text-decoration: none; color: grey;">Esha Kumbhare,</a> Check-out 
            <a href="https://www.linkedin.com/in/krishna-mundada/" style="text-decoration: none; color: grey;"> LinkedIn</a> 
            </li>
            </ul>
            This project was a part of our academic course in 5th sem as a mini project.
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'Krishna' and ad_password == 'lucifer':
                ...
                st.success("Welcome Krishna ! Total %d " % values + " User's Have Used Our Tool : )")                
